...
function Logo() {
  return (
    <div style={{ width: 28, height: 28, borderRadius: 6, background: '#0d1117', border: '1px solid rgba(122,162,255,0.22)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
